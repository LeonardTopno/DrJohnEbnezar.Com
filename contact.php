...
<html lang="en">
	...
	<head>
		...
		<meta name="description" content="Contact Dr. John Ebnezar for appointments, professional communication, orthopaedic care, spine care, and enquiries.">
		<meta name="keywords" content="contact Dr John Ebnezar, appointment, orthopaedic surgeon Bangalore, spine surgeon Bangalore">		
		<!-- SITE TITLE -->
		<title>Contact Dr. John Ebnezar | Appointment & Enquiry</title>			
    ...
    <body data-spy="scroll" data-offset="80">
				...
				<div class="row">
				  <div class="col-lg-6 col-sm-6 col-xs-12 text-center">
					<div class="single_address">
						<h4>Contact Dr. John</h4>
						<p class="mr_20">Email, Mobile No., and WhatsApp details for appointments and enquiries.</p>
						<p><a href="mailto:johnebnezar@gmail.com">johnebnezar@gmail.com</a></p>
						<p><a href="tel:+919986015128">Mobile: +91 99860 15128</a></p>
						<p><a href="https://wa.me/919986015128" target="_blank" rel="noreferrer">WhatsApp: +91 99860 15128</a></p>
					</div>
				  </div><!--- END COL -->
				  <div class="col-lg-6 col-sm-6 col-xs-12 text-center">
					<div class="single_address">
						<h4>Dr. John Ebnezar</h4>
						<p class="mr_20">Department of Orthopedics, Ebnezar Orthopedic Center, Parimala Hospital, Bilekahalli, BG Road, Bengaluru - 560 076, Karnataka, India</p>
					</div>
				  </div><!--- END COL -->
		...
		<!-- START MAP -->
		<div class="map">
			<iframe src="https://www.google.com/maps?q=https%3A%2F%2Fmaps.app.goo.gl%2FNVFJzAmk4Lpc4Spi9&amp;output=embed" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" aria-hidden="false" tabindex="0" title="Dr. John Ebnezar location map"></iframe>
		</div>	
		<div class="text-center" style="margin: 20px 0 40px;">
			<a class="btn_one" href="https://maps.app.goo.gl/NVFJzAmk4Lpc4Spi9" target="_blank" rel="noreferrer">Open in Google Maps</a>
		</div>
		<!-- START MAP -->		
