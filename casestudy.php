...
<html lang="en">
	...
	<head>
		...
		<meta name="description" content="Case study page for Dr. John Ebnezar, highlighting orthopaedic work, public education, wholistic care, and patient-centred practice.">
		<meta name="keywords" content="Dr John Ebnezar case study, orthopaedic case study, wholistic orthopaedics">		
		<!-- SITE TITLE -->
		<title>Case Study | Dr. John Ebnezar</title>			
    ...
    <body data-spy="scroll" data-offset="80">
				...
				<div class="row">
				  <div class="col-lg-6 col-sm-12 col-xs-12">
					<div class="case_content_top">
						<h2>Awesome casestudy to learn more and how to start your business</h2>
						<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin nec eros ut libero laoreet sollicitudin. Suspendisse sit amet scelerisque mauris, in tincidunt sem. Nunc elit turpis, interdum sit amet purus at, tempor dictum diam. Cras ac efficitur quam, ac auctor nibh.</p>
						<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin nec eros ut libero laoreet sollicitudin. Suspendisse sit amet scelerisque mauris, in tincidunt sem. Nunc elit turpis, interdum sit amet purus at, tempor dictum diam. Cras ac efficitur quam, ac auctor nibh.</p>
					</div>
				  </div><!--- END COL -->
				  <div class="col-lg-6 col-sm-12 col-xs-12">
		...
		<!-- START CASE STUDY -->
		<section class="case_content_area section-padding">
			<div class="container">
				<div class="section-title text-center">
					<h2>We are here for all of your service needs</h2>
						...
						<div class="row">
						  ...
						  <div class="col-lg-6 col-sm-12 col-xs-12">
							<div class="case_content">
								<h2>Solution</h2>
								<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin nec eros ut libero laoreet sollicitudin. Suspendisse sit amet scelerisque mauris, in tincidunt sem. Nunc elit turpis, interdum sit amet purus at, tempor dictum diam. Cras ac efficitur quam, ac auctor nibh.</p>
								<p>Proin nec eros ut libero laoreet sollicitudin. Suspendisse sit amet scelerisque mauris, in tincidunt sem. Nunc elit turpis.</p>
							</div>
						  </div><!--- END COL -->
						</div>
					</div><!--- END COL -->
