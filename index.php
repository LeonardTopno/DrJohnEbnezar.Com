...
<html lang="en">
	...
	<head>
		...
		<meta name="description" content="Official website of Padma Shri Rtn. Dr. John Ebnezar, orthopaedic and spine surgeon, author, researcher, educator, and pioneer of wholistic orthopaedics.">
		<meta name="keywords" content="Dr John Ebnezar, orthopaedic surgeon Bangalore, spine surgeon Bangalore, Padma Shri doctor, wholistic orthopaedics">		
		<!-- SITE TITLE -->
		<title>Padma Shri Rtn. Dr. John Ebnezar | Orthopaedic & Spine Surgeon</title>			
    ...
    <body data-spy="scroll" data-offset="80">
	   ...
	   <!-- START HOME -->
		<section id="home" class="home_video html-video">				
			<div class="hero-video-wrap" aria-hidden="true" style="position:absolute; inset:0; overflow:hidden; z-index:0;">
				<iframe
					class="hero-video-embed"
					style="position:absolute; top:50%; left:50%; width:177.78vh; height:56.25vw; min-width:100%; min-height:100%; transform:translate(-50%, -50%) scale(1.18); border:0; pointer-events:none;"
					src="https://www.youtube.com/embed/6PBU8PAUu1A?autoplay=1&mute=1&loop=1&playlist=6PBU8PAUu1A&controls=0&rel=0&modestbranding=1&playsinline=1&enablejsapi=1"
					title="Dr. John Ebnezar featured video"
					frameborder="0"
			...
			<div class="hero-text slider-caption text-center" style="position:absolute; z-index:3;">
				<!--<h2>Orthopaedic Leadership With Global Recognition</h2>-->
			...
			<div class="container">	
				<div class="row feature_bg">
					<div class="section-title text-center">	
						<!--<h4>Padma Shri Rtn. Dr. John Ebnezar's multidimensional legacy in surgery, research, education, and wholistic orthopaedics.</h4>-->	
						<h2>Orthopaedic Stalwart With Global Recognition</h2>
						<p>Padma Shri Rtn. Dr. John Ebnezar's multidimensional legacy in surgery, research, education, and wholistic orthopaedics.</p>
					</div>					
			...
			<div class="container">
				...
				<div class="row text-center">						
					<div class="col-lg-8 offset-lg-2 col-sm-12 col-xs-12 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.3s" data-wow-offset="0">
						<div class="video_btn" style="background-image: url(assets/img/bg/video-bg-1.jpg);  background-size:cover; background-position: center center;">
							<a class="video-play" href="https://www.youtube.com/watch?v=Nl6MBDoZ_zk"><i class="ti-video-clapper"></i></a>
						</div>	
					</div>						
				</div><!--- END ROW -->				
			</div><!--- END CONTAINER -->		
