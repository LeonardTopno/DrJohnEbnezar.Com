...
<html lang="en">
	...
	<head>
		...
		<meta name="description" content="Portfolio and professional highlights from Dr. John Ebnezar.">
		<meta name="keywords" content="Dr John Ebnezar portfolio, orthopaedic surgeon portfolio, professional highlights">		
		<!-- SITE TITLE -->
		<title>Portfolio | Dr. John Ebnezar</title>			
				...
				<div class="row">
				  <div class="col-lg-12 col-sm-12 col-xs-12">
					<div class="single_project">
						...
						<a class="btn_one" href="single_project.php">View Project</a>
					</div>
				  </div><!--- END COL -->
				  <div class="col-lg-12 col-sm-12 col-xs-12">
					<div class="single_project">
