...
<html lang="en">
	...
	<head>
		...
		<meta name="description" content="General about page for Dr. John Ebnezar.">
		<meta name="keywords" content="Dr John Ebnezar about">		
		<!-- SITE TITLE -->
				...
				<div class="row text-center">
					<div class="col-lg-3 col-sm-6 col-xs-12 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s" data-wow-offset="0">
						<div class="our-team">
							...
							<ul class="social">
								<li><a href="https://www.facebook.com/john.ebnezar" class="ti-facebook facebook" target="_blank" rel="noreferrer"></a></li>
								<li><a href="https://x.com/johnebnezar" class="ti-twitter twitter" target="_blank" rel="noreferrer"></a></li>
								<li><a href="https://www.youtube.com/@johnebnezar" class="ti-youtube google" target="_blank" rel="noreferrer"></a></li>
							</ul>						
						</div><!--- END OUR TEAM -->	
					</div><!--- END COL -->	
