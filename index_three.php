...
<html lang="en">
    ...
    <body data-spy="scroll" data-offset="80">
	   ...
	   <!-- START HOME -->
		<div id="kenburns_061" class="carousel slide ps_indicators_txt_icon ps_control_txt_icon data-bs-target kbrns_zoomInOut thumb_scroll_x swipe_x ps_easeOutQuart" data-ride="carousel" data-pause="hover" data-interval="6000" data-duration="2000">
			<div class="carousel-inner" role="listbox">
				<div class="carousel-item active">
					<img src="assets/img/hero/slide-1.avif" alt="Dr. John Ebnezar Guinness World Records slide" />
					<div class="kenburns_061_slide" data-animation="animated fadeInRight">
						<h2>Padma Shri Rtn. Dr. John Ebnezar</h2>
						<h1>Orthopaedic surgeon with global recognition</h1>
						<h3>Clinical leadership, awards, and decades of contribution in orthopaedics and spine care.</h3>
						<a href="about.php">Learn More</a>
					</div>
				</div>
				<div class="carousel-item">
					<img src="assets/img/hero/slide-2.avif" alt="Dr. John Ebnezar centers and institutions slide" />
					<div class="kenburns_061_slide kenburns_061_slide_right" data-animation="animated fadeInLeft">
						<h2>Centers of care</h2>
						<h1>Hospitals, clinics and holistic orthopaedic initiatives</h1>
						<h3>Featuring Parimala Health Care Services, Dr. John's Orthopedic Center, and related institutions.</h3>
						<a href="contact.php">Contact Us</a>
					</div>
				</div>
				<div class="carousel-item">
					<img src="assets/img/hero/slide-3.avif" alt="Dr. John Ebnezar professional roles and achievements slide" />
					<div class="kenburns_061_slide kenburns_061_slide_center" data-animation="animated fadeInDown">
						<h2>Surgeon, researcher, author</h2>
						<h1>A multidimensional legacy in orthopaedics</h1>
						<h3>Educationist, entrepreneur, publisher, social activist, and pioneer of wholistic orthopaedics.</h3>
						<a href="service.php">View Services</a>
					</div>
				</div>
			</div>
			...
			<div class="container">	
				<div class="row feature_bg">
					<div class="section-title text-center">		
						<h2>Orthopaedic Surgeon With Global Recognition</h2>
						<p>Clinical leadership, awards, and decades of contribution in orthopaedics and spine care.</p>
					</div>					
